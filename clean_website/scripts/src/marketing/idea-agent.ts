...
interface BacklogIdea {
  ...
  // The exact words to be spoken by the narration voice (no stage
  // directions, beat labels, or on-screen-text notes, just the narration
  // itself in order). Optional field -- absent on ideas seeded before this
  // existed; the video-agent skips those rather than reading stage
  // directions aloud.
...
interface GeneratedIdea {
  ...
  channel_hint: "instagram" | "facebook" | "video" | "any";
  title: string;
  angle: string;
  trend_reference: string;
  script_or_caption_draft: string;
...
- channel_hint: אחד מ- "instagram" | "facebook" | "video" | "any"
...
- voiceover_text: אך ורק המילים שיוקראו בקול (לצורך יצירת וידאו מונפש אוטומטית עם קריינות) -- ברצף טבעי מההתחלה ועד הסוף, בלי שום תווית בימוי כמו "Hook:" או "טקסט על מסך:", בלי תיאורי מצלמה/עריכה, רק הנאום עצמו בעברית תקינה ורהוטה
