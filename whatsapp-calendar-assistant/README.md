...
You said you already have Google API credentials — this app expects an
**OAuth 2.0 Client ID** (Desktop app type is simplest), not a service
account, since it needs to act on *your* personal calendar.
